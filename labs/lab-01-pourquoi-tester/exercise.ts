...
function testPyramidDistribution(_total: number, _ratios: PyramidRatios): PyramidDistribution {
  // TODO: implementez cette fonction
  throw new Error('Not implemented');
}
...
function shouldWeTest(_codeType: CodeType, _complexity: Complexity, _criticalityScore: number): boolean {
  // TODO: implementez cette fonction
  throw new Error('Not implemented');
}
