...
Maîtriser les matchers Vitest, les tests paramètres, les snapshots et les matchers personnalises.
...
### Exercice 2 : Tests paramètres (each)
Implementez un fizzbuzz et creez des donnees de tests paramètres pour le valider avec un pattern `.each`.
...
Implementez une suite de tests qui utilise `.skip` et `.todo` de manière appropriee.
