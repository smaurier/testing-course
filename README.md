...
| 02 | [`lab-02-pyramide-reelle`](labs/lab-02-pyramide-reelle/README.md) | Zéro | unit → intégration → E2E Playwright sur un écran réel | ✅ vérifié |
...
| 05 | [`lab-05-relire-une-pr-de-tests`](labs/lab-05-relire-une-pr-de-tests/README.md) | Intervention | findings avant vérité sur une PR de tests | ✅ vérifié |
| 06 | [`lab-06-tests-de-contrat`](labs/lab-06-tests-de-contrat/README.md) | Zéro | contrat front/API testé des deux côtés | ✅ vérifié |
